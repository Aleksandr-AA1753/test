# Generated by Django 4.2.9 on 2024-02-24 11:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_customers', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='price_list.customers', verbose_name='Категория клиента')),
            ],
            options={
                'verbose_name': 'Прайс',
