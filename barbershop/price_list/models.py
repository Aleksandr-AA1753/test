...
class Price(models.Model):
    ...
    customers = models.ForeignKey('Customers', on_delete=models.PROTECT, 
        related_name='Customers', verbose_name = "Категория клиента")
    ...
    is_price = models.IntegerField(blank = False, null=True, verbose_name = "Цена")
...
class Category(models.Model):
    ...
    category_slug = models.SlugField(max_length = 250, unique = True, db_index = True, verbose_name="Слаг")
...
class Customers(models.Model):
    customers_name = models.CharField(max_length = 100, db_index = True, verbose_name="Категория клиента")
    customers_slug = models.SlugField(max_length = 250, unique = True, db_index = True, verbose_name ="Слаг")
