# Generated by Django 4.2.9 on 2024-02-23 17:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, default=True, max_length=250, verbose_name='Заголовок')),
                ('slug', models.SlugField(max_length=250, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Минимум 5 символов'), django.core.validators.MaxLengthValidator(250, message='Максимум 250 символов')], verbose_name='Slug')),
                ...
                ('not_published', models.BooleanField(default=False, verbose_name='Снять с публикации')),
                ('photo', models.ImageField(blank=True, default=None, null=True, upload_to='photos/%Y/%m/%d', verbose_name='Загрузите фото')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='category', to='price_list.category', verbose_name='Категории')),
                ('is_customers', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='customers', to='price_list.customers', verbose_name='Категория клиента')),
            ],
            options={
                'verbose_name': 'Прайс',
